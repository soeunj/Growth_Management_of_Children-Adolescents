...
namespace Auxology
{
    public partial class ChartSearchForm : Form
    {
        ...
        {
            if(this.chart_list.CurrentCellAddress.Y != chart_list.RowCount - 1)
            {
                Global.current_chart_num = chart_list.Rows[this.chart_list.CurrentCellAddress.Y].Cells[0].Value.ToString();
                this.DialogResult = DialogResult.OK;
                Global.search_flag = true;
                Global.munjin_count1 = 0;
                Global.predict_count1 = 0;
            }
        }
