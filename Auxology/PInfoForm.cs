    ...
    public partial class PInfoForm : Form
    {
        ...
        private void PInfoForm_Load(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                Global.chart_num = chart.ToString();
        ...
        private void btn_reg_Click(object sender, EventArgs e)
        {
            ...
            string field2 = ",child_name, child_sex, child_birth, man_age, man_month, address_1, address_2,address_3, grade_1, grade_2, p_num1, p_num2, p_num3, hp_num1, hp_num2, hp_num3";
            ...
            string value2 = ",@child_name, @child_sex, @child_birth,  @man_age, @man_month, @address_1, @address_2, @address_3, @grade_1, @grade_2, @p_num1, @p_num2, @p_num3, @hp_num1, @hp_num2, @hp_num3";
            ...
            cmd.Parameters.Add("@mother_height", OleDbType.VarWChar).Value = mh_tb_.Text;
            cmd.ExecuteNonQuery();
            Global.pinfo_register_click_flag = true;
            int temp = Convert.ToInt16(Global.chart_num);
            temp ++;
            Global.chart_num = temp.ToString();
        }
        ...
        private void btn_new_Click(object sender, EventArgs e)
        {
            ...
            adrs_tb2.Text = "";
            adrs_tb3.Text = "";
            gr_rb1.Checked = false;
            gr_rb2.Checked = false;
            gr_rb3.Checked = false;
            gr_tb1.Text = "";
            pn_tb1.Text = "";
            pn_tb2.Text = "";
            pn_tb3.Text = "";
            ...
            Global.search_flag = false;
            Global.pinfo_register_click_flag = false;
            Global.munjin_count2 = 0;
            Global.predict_count2 = 0;
        }

        private async void btn_modify_Click(object sender, EventArgs e)
        {
            if(Global.pinfo_register_click_flag==true)
            {
                connStr = String.Format(connStr, "auxology.mdb");
                OleDbConnection gConn = new OleDbConnection(connStr);
        ...
        private void mname_text_Click(object sender, EventArgs e)
        {
