...
namespace Auxology
{
    ...
    {        
        ...
        public void initialize_data()
        {
            ...
            cb11_1.Checked = false;
            cb11_2.Checked = false;
            cb11_3.Checked = false;
            cb11_4.Checked = false; 
            cb12_1.Checked = false;
            cb12_2.Checked = false;
            cb12_3.Checked = false;
            cb12_4.Checked = false;
            cb12_5.Checked = false;
            cb13_1.Checked = false;
            tb13_1.Text = "";
            tb13_2.Text = "";
            cb13_2.Checked = false;
            cb14_1.Checked = false;
            cb14_2.Checked = false;
            cb14_3.Checked = false;
            cb14_4.Checked = false;
            cb14_5.Checked = false;
            cb14_6.Checked = false;
            cb15_1.Checked = false;
            cb15_2.Checked = false;
            cb15_3.Checked = false;
            cb15_4.Checked = false;
            cb15_5.Checked = false;
            tb16_1.Text = "";
            tb16_2.Text = "";
            tb17_1.Text = "";
            tb18_1.Text = "";
        ...
        public void pinfo_registered_insert_data()
        {
            connStr = String.Format(connStr, "auxology.mdb");
            OleDbConnection gConn = new OleDbConnection(connStr);
            string query = "select chart_num, child_name, reg_date from p_info where chart_num=@chart_num";
